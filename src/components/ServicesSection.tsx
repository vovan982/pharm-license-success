...
const ServicesSection = () => {
  const services = [
    {
      icon: FileCheck,
      title: "Лицензирование по 646н",
      description: "Полное сопровождение получения лицензии на хранение лекарственных средств согласно новым требованиям приказа 646н",
